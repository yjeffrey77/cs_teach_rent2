---
title: "Teacher Veteran Status Report"
execute:
  echo: false
  message: false
  warning: false
...
gxs<-lapply(1:length(teach_yr_string), function(x){
  ...
  teach_year <- teach_yr_string[[x]]
  type<-"elem"
  df_cs<-toc_rent_overall_elem[["cs"]][["original_5"]][[teach_year]]
  df_ts<-toc_rent_overall_elem[["ts"]][["original_5"]][[teach_year]]
...
gxs<-lapply(1:length(teach_yr_string), function(x){
  ...
  teach_year <- teach_yr_string[[x]]
  type<-"ms_hs"
  df_cs<-toc_rent_overall_ms_hs[["cs"]][["original_5"]][[teach_year]]
  df_ts<-toc_rent_overall_ms_hs[["ts"]][["original_5"]][[teach_year]]
